...
# AUTHOR:         
# DESCRIPTION:    Cloud Assistants application hellowab
# TO_BUILD:        cafjs mkImage . gcr.io/cafjs-k8/<user>-hellowab
# TO_RUN:         cafjs run --appImage gcr.io/cafjs-k8/<user>-hellowab hellowab
